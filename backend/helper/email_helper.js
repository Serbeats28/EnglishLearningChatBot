...
const transporter = nodemailer.createTransport({
    ...
    secure: true, 
    auth: {
			user: 'servitojerwin@gmail.com', //process.env.EMAIL_USER, // Use environment variables!
			pass: 'wmaiiovttjkyryew' //process.env.EMAIL_PASS, // Your 16-character App Password
    },
})
